...
These are real, hand-crafted sites that represent the quality target for this skill. Before generating any site or page, internalize what these sites do and why they work.

| Site | Type | Key Patterns |
|---|---|---|
| Foundry (`site-examples/foundry.md`) | Developer tools SaaS landing page | Token system, OKLCH accents, fluid type, command palette, comparison slider, density system |

**The Foundry Standard:** Every site generated by this skill should feel as polished, specific, and production-ready as Foundry. Read `site-examples/foundry.md` in full before generating any dark-themed technical product site.
...
- Would this feel credible next to Foundry (`site-examples/foundry.md`) or a Vercel/Linear-quality site?
...
| Production reference sites | `site-examples/` |
